...
<!-- ------------------ -->
    ...
    <div class="panel panel-headline">
      <div class="panel-heading">
        ...
        <p class="panel-subtitle">Generar nueva nota de debito</p>
      </div>
      <div class="panel-body">
        <div class="row">
          <div class="col-md-12">
            <form action="{{ route('debito.store') }}" method="POST">
              {{ csrf_field() }}
              {{ method_field('POST') }}
              ...
              <div class="form-group col-md-12 col-xs-12">
                <button type="submit" class="btn btn-success">Crear nota de debito</button>
                <a href="{{ route('debito.index') }}" class="btn btn-default">Cancelar</a>
              </div>
            </form>
          </div>
        </div>
