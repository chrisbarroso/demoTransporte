  ...
  <div class="col-md-12 col-xs-12">
    <div class="panel">
      <div class="panel-heading">
        <h3 class="panel-title">Notas de credito registradas</h3>
      </div>
      <div class="panel-body no-padding">
        ...
        @if (count($notas) > 0)
									...
									<div class="modal fade" id="confirmarEliminar{{ $nota->id}}" tabindex="-1" role="dialog" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<form action="{{ route('credito.destroy', ['credito' => $nota->id]) }}" method="POST" class="form-inline">
													<div class="modal-body">
														<h5>Estas seguro que quiere dar de baja esta nota de credito?</h5>
          ...
          {{ $notas->links() }}
          @else
            <p>No hay notas de credito registrados</p>
          @endif
        </div>
      </div>
      <div class="panel-footer">
        <div class="row">
          <div class="col-md-12 text-right">
            <a class="btn btn-primary" href="{{ route('credito.create')}}">Registrar nota de credito</a>
          </div>
        </div>
      </div>
